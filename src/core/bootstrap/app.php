...
try {
    // Ignore completely core .env files, just take the ones
...
// $app->middleware([
//    Bryo\Http\Middleware\ExampleMiddleware::class
// ]);

// $app->routeMiddleware([
//     'auth' => Bryo\Http\Middleware\Authenticate::class,
// ]);
...
// $app->register(Bryo\Providers\AppServiceProvider::class);
// $app->register(Bryo\Providers\AuthServiceProvider::class);
// $app->register(Bryo\Providers\EventServiceProvider::class);
...
$app->group(['namespace' => 'Bryo\Http\Controllers'], function ($app) {
    require __DIR__.'/../bryo/Http/routes.php';
});
